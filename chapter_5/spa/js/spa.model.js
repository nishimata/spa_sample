...
spa.model = (function () {
  ...
  //   * get_is_user()ーオブジェクトが現在のユーザの場合にtrueを返す。
  ...
  makePerson = function ( person_map ) {
    console.log("spa.model.js makePerson start");
    var
      person,
      cid     = person_map.cid,
    ...
    console.log("spa.model.js makePerson end");
    return person;
  };
  ...
  //   * spa-updatechatーこれは新しいメッセージを送受信したときに発行される。
  //     以下に形式のマップをデータとして提供する。
  //      { dest_id   : <chatee_i>,
  ...
  initModule = function () {
    console.log("spa.model.js initModule start");
    ...
    stateMap.user = stateMap.anon_user;
    console.log(stateMap);
    console.log("spa.model.js initModule end");
  };
