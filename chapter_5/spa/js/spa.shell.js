...
spa.shell = (function () {
  ...
  // 戻り値 : boolean
  //   * true ーURIのアンカー部分が更新された
  //   * falseーURIのアンカー部分が更新できなかった
  // 動作 :
  ...
  initModule = function ( $container ) {
    console.log("spa.shell.js initModule start");
    ...
    // そうしないと、トリガーイベントを処理でいる状態になっていない。
    ...
    jqueryMap.$acct
      .text( 'Please sign-in' )
      .bind( 'utap', onTapAcct );
    console.log("spa.shell.js initModule end");
  };
